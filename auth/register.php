...
<body>
  <form method="post" enctype="multipart/form-data" action="../handels/handelRegister.php" class="w-50 m-auto mt-5 p-5 rounded bg-primary-subtle text-dark">
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input name="email" type="email" class="form-control" id="userEmail" aria-describedby="nameHelp">
    </div>
